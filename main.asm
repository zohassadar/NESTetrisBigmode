...
set_seed        := $0064
sps_menu        := $0067
menuSeedCursorIndex := $0068
menuMoveThrottle := $0069
menuThrottleTmp := $006A
seedVersion := $006B
spriteXOffset   := $00A0
spriteYOffset   := $00A1
...
gameMode_legalScreen:
        ...
        jsr     memset_page
        lda     #$FF
        jsr     sleep_for_a_vblanks_and_bail_on_start
        lda     #$FF
        sta     generalCounter
@waitForStartButton:
...
nextBoxT:
        .byte   $C6,$C7,$C7,$C8,$FD  ; 7b
        .byte   $FF,$C6,$C8,$FF,$FD
nextBoxJ:
        .byte   $E6,$E7,$E7,$E8,$FD  ;7d
        .byte   $FF,$FF,$E6,$E8,$FD
nextBoxZ:
        .byte   $D6,$D7,$D8,$FF,$FD  ;7c
        .byte   $FF,$D6,$D7,$D8,$FD
nextBoxO:
        .byte   $FF,$7B,$7B,$FF,$FD  ;7b
        .byte   $FF,$7B,$7B,$FF,$FD
nextBoxS:
        .byte   $FF,$E6,$E7,$E8,$FD  ;7d
        .byte   $E6,$E7,$E8,$FF,$FD
nextBoxL:
        .byte   $D6,$D7,$D7,$D8,$FD  ;7c
        .byte   $D6,$D8,$FF,$FF,$FD
nextBoxI:
        .byte   $E9,$E9,$E9,$E9,$FD
        .byte   $F9,$F9,$F9,$F9,$FD ; 7b
nextBoxNo:
        .byte   $FF,$FF,$FF,$FF,$FD
        .byte   $FF,$FF,$FF,$FF,$FD
...
sleep_for_a_vblanks_and_bail_on_start:
        sta     sleepCounter
@loop:  jsr     updateAudioWaitForNmiAndResetOamStaging
        lda     newlyPressedButtons_player1
        and     #BUTTON_START
